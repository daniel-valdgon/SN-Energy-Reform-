...
*----------- Uprating 	
	...
	replace consumption_electricite=consumption_electricite*(4662/3668)/ (1.027*1.026*1.026) //discounting population growth to do the uprating  
